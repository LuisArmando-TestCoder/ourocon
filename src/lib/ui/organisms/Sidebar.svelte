...
<aside class="sidebar" class:collapsed={$collapsed}>
  <button class="sidebar__toggle" on:click={() => collapsed.update(n => !n)} aria-expanded={!$collapsed} aria-controls="sidebar-nav">
    ...
    <ul class="sidebar__nav-list">
      {#each links as link}
        <li class="sidebar__nav-item">
          <a href={link.url} class="sidebar__nav-link">{link.name}</a>
        </li>
      {/each}
    </ul>
  </nav>
